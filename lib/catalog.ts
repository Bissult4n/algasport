...
export const products: Product[] = [
  ...
  ...[
    [
      "activize",
      "Activize",
      "Порошковый напиток Oxyplus с витаминами и кофеином.",
      "Черная смородина",
      "0708054",
    ],
    [
      "restorate",
      "Restorate",
      "Порошковый напиток с минералами и витамином D3.",
    ...
    [
      "basics",
      "Basics",
      "Порошковый напиток с витаминами, селеном и пищевыми волокнами.",
      "Апельсин",
      "0705066",
    ],
    [
      "powercocktail",
      "PowerCocktail",
      "Порционный напиток с витаминами и пищевыми волокнами. Содержит кофеин.",
    ...
    ([id, name, description, variant, code]): Product => ({
      ...
      description,
      detail:
        "Пищевая добавка, не лекарственное средство. Состав и рекомендации по применению смотрите на упаковке. Вариант упаковки и наличие уточним перед заказом.",
      source: "https://www.fitline.com/us/en-us/products/" + code,
